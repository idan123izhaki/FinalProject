...
//decoder function
std::string fec::decoder(RaptorQ::Block_Size block, uint32_t chunk_size, uint32_t symbol_size,
...
//    }
    ...
    if (decoded.written != chunk_size) {
        ...
        //return false;
        throw std::runtime_error("the RQ algorithm failure while decoding");
    } else {
