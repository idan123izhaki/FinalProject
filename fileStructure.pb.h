...
class ConfigPacket PROTOBUF_FINAL :
 ...
 public:
  ...
  void clear_con_type();
  ::FILE_STORAGE::ContentType con_type() const;
  void set_con_type(::FILE_STORAGE::ContentType value);
  private:
  ::FILE_STORAGE::ContentType _internal_con_type() const;
  void _internal_set_con_type(::FILE_STORAGE::ContentType value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_block_size() const;
  void _internal_set_block_size(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
...
// .FILE_STORAGE.ContentType con_type = 2;
inline void ConfigPacket::clear_con_type() {
  con_type_ = 0;
}
inline ::FILE_STORAGE::ContentType ConfigPacket::_internal_con_type() const {
  return static_cast< ::FILE_STORAGE::ContentType >(con_type_);
}
inline ::FILE_STORAGE::ContentType ConfigPacket::con_type() const {
  // @@protoc_insertion_point(field_get:FILE_STORAGE.ConfigPacket.con_type)
  return _internal_con_type();
}
inline void ConfigPacket::_internal_set_con_type(::FILE_STORAGE::ContentType value) {
  
  con_type_ = value;
}
inline void ConfigPacket::set_con_type(::FILE_STORAGE::ContentType value) {
  _internal_set_con_type(value);
  // @@protoc_insertion_point(field_set:FILE_STORAGE.ConfigPacket.con_type)
}
...
// uint64 block_size = 6;
inline void ConfigPacket::clear_block_size() {
  block_size_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ConfigPacket::_internal_block_size() const {
  return block_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ConfigPacket::block_size() const {
  // @@protoc_insertion_point(field_get:FILE_STORAGE.ConfigPacket.block_size)
  return _internal_block_size();
}
inline void ConfigPacket::_internal_set_block_size(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  block_size_ = value;
}
inline void ConfigPacket::set_block_size(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
// uint32 overhead = 8;
inline void ConfigPacket::clear_overhead() {
  overhead_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 ConfigPacket::_internal_overhead() const {
  return overhead_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 ConfigPacket::overhead() const {
  // @@protoc_insertion_point(field_get:FILE_STORAGE.ConfigPacket.overhead)
  return _internal_overhead();
}
inline void ConfigPacket::_internal_set_overhead(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  overhead_ = value;
}
inline void ConfigPacket::set_overhead(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
template <> struct is_proto_enum< ::FILE_STORAGE::ContentType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FILE_STORAGE::ContentType>() {
  return ::FILE_STORAGE::ContentType_descriptor();
}
